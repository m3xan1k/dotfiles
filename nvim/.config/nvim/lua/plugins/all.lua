...
return {"nvim-lua/plenary.nvim", "nvim-telescope/telescope.nvim", "ntk148v/komau.vim", {"akinsho/bufferline.nvim", config = _1_, dependencies = {"nvim-tree/nvim-web-devicons", lazy = true}, version = "*"}, {"utilyre/barbecue.nvim", config = _2_, dependencies = {{"SmiteshP/nvim-navic", lazy = true}, {"nvim-tree/nvim-web-devicons", lazy = true}}, version = "*"}, {"nvim-lualine/lualine.nvim", dependencies = {"nvim-tree/nvim-web-devicons"}}, {"lewis6991/gitsigns.nvim", config = _3_}, {"kevinhwang91/nvim-hlslens", config = _4_}, {"karb94/neoscroll.nvim", config = _5_}, {"VonHeikemen/lsp-zero.nvim", branch = "v2.x", dependencies = {"neovim/nvim-lspconfig", {"williamboman/mason.nvim", build = _6_}, "williamboman/mason-lspconfig.nvim", "hrsh7th/nvim-cmp", "hrsh7th/cmp-nvim-lsp", "hrsh7th/cmp-path", "hrsh7th/cmp-buffer", "L3MON4D3/LuaSnip"}}, "jose-elias-alvarez/null-ls.nvim", "tpope/vim-surround", {"windwp/nvim-autopairs", config = _7_}, {"terrortylor/nvim-comment", config = _8_}, {"folke/which-key.nvim", config = _9_}, "RRethy/vim-illuminate", {"nvim-treesitter/nvim-treesitter", config = _10_}, {"kevinhwang91/nvim-ufo", lazy = true, ft = {"json"}, dependencies = {{"kevinhwang91/promise-async", lazy = true}, {"luukvbaal/statuscol.nvim", lazy = true, config = _11_}}}, "preservim/nerdtree", "ntpeters/vim-better-whitespace", "vimwiki/vimwiki", "ryanoasis/vim-devicons", "Olical/conjure", "tpope/vim-dispatch", "clojure-vim/vim-jack-in", "radenling/vim-dispatch-neovim", {"gpanders/nvim-parinfer", ft = {"fennel", "clojure", "commonlisp", "racket", "clojurescript"}}, {"kristijanhusak/vim-dadbod-ui", dependencies = {{"tpope/vim-dadbod"}, {"kristijanhusak/vim-dadbod-completion", config = _12_}, "tpope/vim-surround", "windwp/nvim-autopairs"}, cmd = "DBUI"}, {"nvim-orgmode/orgmode", dependencies = {{"nvim-treesitter/nvim-treesitter", lazy = true}}, event = "VeryLazy", config = _13_}}
