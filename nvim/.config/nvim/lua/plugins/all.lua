...
return {{"nvim-lua/plenary.nvim", lazy = true}, {"nvim-telescope/telescope.nvim", lazy = true}, "https://codeberg.org/m3xan1k/simple", {"akinsho/bufferline.nvim", config = _1_, dependencies = {"nvim-tree/nvim-web-devicons", lazy = true}, version = "*", event = "BufReadPre"}, {"utilyre/barbecue.nvim", config = _2_, dependencies = {{"SmiteshP/nvim-navic", lazy = true}, {"nvim-tree/nvim-web-devicons", lazy = true}}, version = "*", after = "VonHeikemen/lsp-zero.nvim", event = "BufReadPre"}, {"nvim-lualine/lualine.nvim", dependencies = {"nvim-tree/nvim-web-devicons", lazy = true}}, {"lewis6991/gitsigns.nvim", config = _3_, event = "BufReadPre"}, {"kevinhwang91/nvim-hlslens", config = _4_, event = "BufReadPre"}, {"karb94/neoscroll.nvim", config = _5_, event = "BufReadPre"}, {"VonHeikemen/lsp-zero.nvim", branch = "v2.x", dependencies = {{"neovim/nvim-lspconfig"}, {"williamboman/mason.nvim", build = _6_}, {"williamboman/mason-lspconfig.nvim"}, {"hrsh7th/nvim-cmp"}, {"hrsh7th/cmp-nvim-lsp"}, {"L3MON4D3/LuaSnip"}}}, {"hrsh7th/cmp-path", event = "BufReadPre"}, {"hrsh7th/cmp-buffer", event = "BufReadPre"}, {"jose-elias-alvarez/null-ls.nvim", event = "BufReadPre"}, "tpope/vim-surround", {"windwp/nvim-autopairs", config = _7_, event = "BufReadPre"}, {"terrortylor/nvim-comment", config = _8_, event = "BufReadPre"}, {"folke/which-key.nvim", config = _9_}, "rmagatti/auto-session", {"RRethy/vim-illuminate", event = "BufReadPre"}, {"nvim-treesitter/nvim-treesitter", config = _10_, event = "BufReadPre"}, {"kevinhwang91/nvim-ufo", dependencies = {"kevinhwang91/promise-async", {"luukvbaal/statuscol.nvim", config = _11_}}}, "preservim/nerdtree", {"ntpeters/vim-better-whitespace", event = "BufReadPre"}, {"vimwiki/vimwiki", ft = "markdown"}, {"ryanoasis/vim-devicons", lazy = true}, "Olical/conjure", "tpope/vim-dispatch", "clojure-vim/vim-jack-in", "radenling/vim-dispatch-neovim", {"gpanders/nvim-parinfer", ft = {"fennel", "clojure", "commonlisp", "racket", "clojurescript"}}}
